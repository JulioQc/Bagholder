...
Every image is the same made-up book, generated by [`docs/screenshots/demo_book.py`](docs/screenshots/demo_book.py). None of it is anyone's account.
...
The same book on the phone, iOS above and Android below:
