...
class FixtureTest(unittest.TestCase):
    def test_every_case_matches(self):
        paths = sorted(glob.glob(os.path.join(os.path.dirname(os.path.abspath(__file__)), "cases", "*.json")))
    ...
    def test_cases_are_current(self):
        ...
        for name, case in make_cases.CASES.items():
            with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "cases", name + ".json")) as f:
