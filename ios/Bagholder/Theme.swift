...
struct BHTheme {
    ...
    static let nocturne = BHTheme(
        ...
        pie: [hex(0x9184d9), hex(0x6fd39b), hex(0x5fb0e6), hex(0xe8b36a), hex(0xe0778a), hex(0x7fd3c9), hex(0xc48fdc), hex(0xd7c46a), hex(0xe59a6a), hex(0x8fb87a), hex(0xa0a8b8)]
    )
    ...
    static let light = BHTheme(
        ...
        pie: [hex(0xa89ee6), hex(0x8fd4b4), hex(0x93c4ec), hex(0xf0c98c), hex(0xeea3ae), hex(0x9adbd4), hex(0xcfaee6), hex(0xe0d48c), hex(0xf2b592), hex(0xb9d69c), hex(0xb6bec9)]
    )
